...
export class UserControllerBase {
  ...
  async findStorages(
    ...
    const results = await this.service.findStorages(params.id, {
      ...query,
      select: {
        capacity: true,
        createdAt: true,
  ...
  @common.Post("/:id/storages")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async connectStorages(
    @common.Param() params: UserWhereUniqueInput,
  ...
  @common.Delete("/:id/storages")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectStorages(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: StorageWhereUniqueInput[]
  ): Promise<void> {
    const data = {
